...
@app_myviews.route('/interpretations/<word_id>/<song_id>', methods=['GET'],
...
@app_myviews.route('/interpretations/<word_id>/<song_id>', methods=['POST'],
                 strict_slashes=False)
...
@app_myviews.route('/interpretations/<interpretation_id>', methods=['PUT'],
                 strict_slashes=False)
