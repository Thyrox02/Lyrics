...
from api.v1.myviews import app_myviews
from models.song import Song
app = Flask(__name__)


@app_myviews.route('/songs', methods=['GET'], strict_slashes=False)
def get_songs():
...
@app_myviews.route('/songs/<text>', methods=['GET'], strict_slashes=False)
def get_song(text):
...
@app_myviews.route('/songs/genre/<genre>', methods=['GET'], strict_slashes=False)
